...
import com.sakethh.linkora.ui.screens.settings.Preferences.changeSettingPreferenceValue
...
class RefreshLinksWorkerRequestBuilder @Inject constructor(
    ...
    suspend fun request(): OneTimeWorkRequest {
        ...
        changeSettingPreferenceValue(
            stringPreferencesKey(PreferenceType.CURRENT_WORK_MANAGER_WORK_UUID.name),
            context.dataStore,
            request.id.toString()
        )
