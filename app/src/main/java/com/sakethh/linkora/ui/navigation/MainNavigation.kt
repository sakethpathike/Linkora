...
fun MainNavigation(
    ...
    NavHost(
        ...
        startDestination = if (Preferences.isHomeScreenEnabled.value.not() && Preferences.startDestination.value == HomeScreenRoute.toString()) {
            CollectionsScreenRoute
        } else when (Preferences.startDestination.value) {
